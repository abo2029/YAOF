...
### 必要的 Patches ###
# 5Gdev_add_Quectel_RG801H_EA
cp -f ../PATCH/kernel_5Gdev/999-kernel-option-add-new-dev.patch ./target/linux/x86/patches-5.4/999-kernel-option-add-new-dev.patch
# Patch arm64 型号名称
